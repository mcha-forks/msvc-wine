...
export INCLUDE="$MSVCDIR/atlmfc/include;$MSVCDIR/include;$SDKINCLUDE/shared;$SDKINCLUDE/ucrt;$SDKINCLUDE/um;$SDKINCLUDE/winrt;$SDKINCLUDE/cppwinrt;$NETFXBASE/include"
export LIB="$MSVCDIR/atlmfc/lib/$ARCH;$MSVCDIR/lib/$ARCH;$SDKLIB/ucrt/$ARCH;$SDKLIB/um/$ARCH;$NETFXBASE/lib"
